...
export const setPattern = triggers.create<[number]>("SetPattern");
...
export const toggleTransitSignalPriorityForTrams = triggers.create<[boolean]>("ToggleTransitSignalPriorityForTrams");
export const toggleTransitSignalPriorityForBuses = triggers.create<[boolean]>("ToggleTransitSignalPriorityForBuses");
...
export const setPanelState = triggers.create<[number]>("SetPanelState");
...
export const exitAddMemberMode = triggers.create<[]>("ExitAddMemberMode");
export const finishAddMemberMode = triggers.create<[]>("FinishAddMemberMode");
...
export const callMatchPhaseDurationsToLeader = triggers.create<[string]>("CallMatchPhaseDurationsToLeader");
