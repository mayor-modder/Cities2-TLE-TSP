...
import { SubLaneInfo, CustomPhaseLaneType, CustomPhaseLane, EdgeInfo, ScreenPoint, CustomPhaseLaneDirection, CustomPhaseSignalState, SubLaneGroupMask, EdgeGroupMask } from 'mods/general';
