export default {
  ...
  TspUnavailableForTrafficGroup: "Transit Signal Priority is unavailable for intersections that are part of a traffic group. Remove this intersection from the traffic group to re-enable TSP.",
  ...
  AllowCoordinatedTsp: "Allow Coordinated TSP",
